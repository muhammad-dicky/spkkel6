...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 16 Jul 2022 pada 16.25
...
(1, 26, 1),
(2, 25, 0.7325581395348838),
(3, 24, 0.3604651162790697),
(4, 27, 1),
(5, 30, 0.956678700361011),
(6, 31, 0.6137184115523467),
(7, 32, 0.4620938628158846),
(8, 39, 1),
(9, 38, 0.7972972972972973),
(10, 37, 0.6351351351351351),
(11, 41, 0.7972972972972973),
(12, 40, 1),
(13, 42, 0.6351351351351351),
(14, 35, 1),
(15, 36, 0.9091499026606098),
(16, 33, 0.7826086956521737),
(17, 34, 0.345230369889682);
...
(1, '127.0.0.1', 'administrator', '$2a$07$SeBknntpZror9uyftVopmu61qg0ms8Qv1yV6FG.kQOSM.9QhmTo36', '', 'admin@admin.com', '', NULL, NULL, 'c.JN/a5NatMoXrnk5WrY1.', 1268889823, 1657980093, 1, 'Admin', 'istrator', 'ADMIN', '0');
...
--
ALTER TABLE `kriteria_nilai`
  MODIFY `id_kriteria_nilai` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=221;
...
--
ALTER TABLE `subkriteria_nilai`
  MODIFY `id_subkriteria_nilai` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=61;
