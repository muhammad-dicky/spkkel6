...
<div class="jarallax agileits-team agile-section" id="team">
	...
	<div class="grid">
		<figure class="col-md-3 effect-kira">
			<img src="<?php echo base_url() ?>frontend/web/images/t1.jpg" alt="t1" class="img-responsive"/>
			<figcaption>
				<h4>Williams</h4>
		...
		<figure class="col-md-3 effect-kira">
			<img src="<?php echo base_url() ?>frontend/web/images/t2.jpg" alt="t2" class="img-responsive"/>
			<figcaption>
		...
		<figure class="col-md-3 effect-kira">
			<img src="<?php echo base_url() ?>frontend/web/images/t3.jpg" alt="t3" class="img-responsive"/>
			<figcaption>
				<h4>Irving</h4>
				<h5>art</h5>
				<p>
		...
		<figure class="col-md-3 effect-kira">
			<img src="<?php echo base_url() ?>frontend/web/images/t4.jpg" alt="t4" class="img-responsive"/>
			<figcaption>
				<h4>Kenny</h4>
				<h5>Dept. of maths</h5>
				<p>
		...
		<figure class="col-md-3 effect-kira">
			<img src="<?php echo base_url() ?>frontend/web/images/t5.jpg" alt="t5" class="img-responsive"/>
			<figcaption>
				<h4>Lawrence</h4>
		...
		<figure class="col-md-3 effect-kira">
			<img src="<?php echo base_url() ?>frontend/web/images/t6.jpg" alt="t6" class="img-responsive"/>
			<figcaption>
				<h4>Jackson</h4>
		...
		<figure class="col-md-3 effect-kira">
			<img src="<?php echo base_url() ?>frontend/web/images/t7.jpg" alt="t7" class="img-responsive"/>
			<figcaption>
				<h4>Stephen</h4>
		...
		<figure class="col-md-3 effect-kira">
			<img src="<?php echo base_url() ?>frontend/web/images/t8.jpg" alt="t8" class="img-responsive"/>
			<figcaption>
				<h4>Goode</h4>
				<h5>sports coach</h5>
				<p>
...
<script type="text/javascript" src="<?php echo base_url() ?>frontend/web/js/numscroller-1.0.js"></script>
<!-- //Stats -->  
<!--testimonials-->
											  ...
											  <div class="col-md-6 col-sm-6 col-xs-6 customer-grid">
												<div class="de_testi">
													<div class="de_testi_by">
														...
														<div class="quotes">
															<img src="<?php echo base_url() ?>frontend/web/images/p1.jpg" alt="">
											...
											<div class="col-md-6 col-sm-6 col-xs-6 customer-grid">
												<div class="de_testi">
													<div class="de_testi_by">
														...
														<p> Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
														<div class="quotes">
															<img src="<?php echo base_url() ?>frontend/web/images/p2.jpg" alt="">
											  ...
											  <div class="col-md-6 col-sm-6 col-xs-6 customer-grid">
												<div class="de_testi">
													<div class="de_testi_by">
														...
														<p> Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
														<div class="quotes">
															<img src="<?php echo base_url() ?>frontend/web/images/p3.jpg" alt="">
	...
	<div class="container">
		<div class="agileinfo-footer">
			...
			<div class="col-md-6 col-sm-6 w3_agile-copyright text-center">
				<p>© Scholar. All rights reserved | Design by <a href="//w3layouts.com/">W3layouts</a></p>
			</div>
		</div>
	</div>
</div>
